...
public void addBegin(NodoA nuevo){
  if (isEmpty()){
    inicio = nuevo;
    fin = nuevo;
}else{
...
public void insertAt(int pos, NodoA nuevo) throws Exception{// quien use este metodo es responsable de la excepcion que genere
    int iTama= size();
    if ((pos < 0)|| (pos >= iTama)){
